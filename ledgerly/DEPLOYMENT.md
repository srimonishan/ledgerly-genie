# Ledgerly — Full Deployment Guide

The complete, click-by-click Databricks Free Edition + optional AWS setup.
See [README.md](README.md) for the project overview, [ROADMAP.md](ROADMAP.md)
for what's intentionally **not** built yet, and
[PROJECT_STORY.md](PROJECT_STORY.md) for the contest write-up.
